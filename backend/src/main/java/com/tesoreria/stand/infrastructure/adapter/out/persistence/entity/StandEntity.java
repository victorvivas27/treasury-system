...
public class StandEntity {
  ...
  @JoinColumn(name = "event_id", nullable = false) private SchoolEventEntity event;
  @Column(nullable = false, length = 120) private String name;
  @Column(name = "stand_date", nullable = false) private LocalDate date;
  @Column(name = "start_time", nullable = false) private LocalTime startTime;
  @Column(name = "end_time", nullable = false) private LocalTime endTime;
  @Column(nullable = false, length = 150) private String responsible;
  ...
  @Enumerated(EnumType.STRING) @Column(name = "payment_method", length = 20)
