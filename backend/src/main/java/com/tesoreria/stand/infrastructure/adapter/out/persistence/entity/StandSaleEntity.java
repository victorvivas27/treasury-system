...
public class StandSaleEntity {
  ...
  @Column(name = "amount_received", precision = 14, scale = 2) private BigDecimal amountReceived;
  @Column(name = "change_amount", precision = 14, scale = 2) private BigDecimal changeAmount;
  @Column(length = 500) private String observation;
  @Column(name = "registered_by", nullable = false, length = 150) private String registeredBy;
  @Column(name = "sold_at", nullable = false) private LocalDateTime soldAt;
  @Enumerated(EnumType.STRING) @Column(length = 20)
  private StandSaleStatus status = StandSaleStatus.ACTIVE;
  @Column(name = "cancelled_at") private LocalDateTime cancelledAt;
  @Column(name = "cancelled_by", length = 150) private String cancelledBy;
  ...
  @Column(name = "modified_by", length = 150) private String modifiedBy;
  @Column(name = "modification_reason", length = 500) private String modificationReason;
}
