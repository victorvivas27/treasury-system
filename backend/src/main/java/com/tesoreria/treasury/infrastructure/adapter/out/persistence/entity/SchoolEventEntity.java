...
public class SchoolEventEntity {
  ...
  @Enumerated(EnumType.STRING) @Column(nullable = false, length = 25) private EventStatus status;
  ...
  @Column(name = "gross_revenue", precision = 14, scale = 0) private BigDecimal grossRevenue;
  @Column(name = "revenue_date") private LocalDate revenueDate;
  @Column(name = "revenue_description", length = 250) private String revenueDescription;
  @Column(name = "revenue_payment_method", length = 40) private String revenuePaymentMethod;
  @Column(name = "revenue_receipt", length = 100) private String revenueReceipt;
  @Column(name = "revenue_notes", length = 500) private String revenueObservations;
  @Column(name = "settlement_remainder", precision = 14, scale = 0) private BigDecimal remainder;
  @Column(name = "settlement_confirmed", nullable = false) private boolean settlementConfirmed;
