...
public class JpaTreasuryRepositoryAdapter implements TreasuryRepositoryOutPort {
    ...
    @Override
    public AnnualFeeConfig saveConfig(AnnualFeeConfig value) {
    ...
    @Override
    public List<AnnualFeeConfig> findAllConfigs() {
        return configs.findAll().stream().map(this::config).toList();
    }

    @Override
    public FamilyFeePlan savePlan(FamilyFeePlan value) {
        return plan(plans.save(planEntity(value)));
    }

    @Override
    public Optional<FamilyFeePlan> findPlan(Long configId, Long familyId) {
        return plans.findByConfigIdAndFamilyId(configId, familyId).map(this::plan);
    }

    @Override
    public Optional<FamilyFeePlan> findPlanById(Long id) {
    ...
    @Override
    public FeeObligation saveObligation(FeeObligation value) {
        return obligation(obligations.save(obligationEntity(value)));
    }

    @Override
    public Optional<FeeObligation> findObligationById(Long id) {
    ...
    @Override
    public Optional<FeePayment> findActivePayment(Long obligationId) {
    ...
    @Override
    public boolean hasActivePaymentForPlan(Long planId) {
    ...
    @Override
    public void deletePaymentsByPlan(Long planId) {
    ...
    @Override
    public TreasuryAudit saveAudit(TreasuryAudit value) {
        TreasuryAuditEntity entity = new TreasuryAuditEntity();
        entity.setId(value.id());
        entity.setAction(value.action());
        entity.setEntityType(value.entityType());
        entity.setEntityId(value.entityId());
        entity.setPerformedBy(value.performedBy());
    ...
    @Override
    public Optional<FamilyContribution> findContributionById(Long id) {
    ...
    @Override
    public TreasuryExpense saveExpense(TreasuryExpense value) {
        return expense(expenses.save(expenseEntity(value)));
    }

    @Override
    public Optional<TreasuryExpense> findExpenseById(Long id) {
    ...
    @Override
    public TreasuryIncome saveIncome(TreasuryIncome value) {
        return income(incomes.save(incomeEntity(value)));
    }

    @Override
    public Optional<TreasuryIncome> findIncomeById(Long id) {
    ...
    @Override
    public void deleteAudits(String entityType, String entityId) {
    ...
    private AnnualFeeConfigEntity configEntity(AnnualFeeConfig v) {
        ...
        e.setId(v.id());
        e.setYear(v.year());
        e.setAnnualAmount(v.annualAmount());
        e.setAllowedMode(v.allowedMode());
        e.setAnnualDueDate(v.annualDueDate());
        e.setFirstDueDate(v.firstDueDate());
        e.setSecondDueDate(v.secondDueDate());
    ...
    private FamilyFeePlanEntity planEntity(FamilyFeePlan v) {
        ...
        e.setId(v.id());
        e.setConfigId(v.configId());
        e.setFamilyId(v.familyId());
        e.setMode(v.mode());
        e.setCreatedAt(v.createdAt());
        e.setUpdatedAt(v.updatedAt());
        return e;
    ...
    private FeeObligationEntity obligationEntity(FeeObligation v) {
        ...
        e.setId(v.id());
        e.setPlanId(v.planId());
        e.setInstallment(v.installment());
        e.setConcept(v.concept());
        e.setAmount(v.amount());
        e.setDueDate(v.dueDate());
    ...
    private FeePaymentEntity paymentEntity(FeePayment v) {
        ...
        e.setId(v.id());
        e.setObligationId(v.obligationId());
        e.setPaymentDate(v.paymentDate());
        e.setAmount(v.amount());
        e.setRegisteredBy(v.registeredBy());
        e.setObservations(v.observations());
        e.setAnnulled(v.annulled());
        e.setAnnulledAt(v.annulledAt());
        e.setAnnulledBy(v.annulledBy());
        e.setAnnulmentReason(v.annulmentReason());
        e.setCreatedAt(v.createdAt());
        return e;
    }
    ...
    private ContributionConfigEntity contributionConfigEntity(ContributionConfig v) {
        ...
        e.setId(v.id());
        e.setSchoolYear(v.schoolYear());
        e.setType(v.type());
        e.setName(v.name());
        e.setActive(v.active());
        e.setReferenceAmount(v.referenceAmount());
        e.setObservations(v.observations());
        e.setCreatedAt(v.createdAt());
        e.setUpdatedAt(v.updatedAt());
        return e;
    ...
    private FamilyContributionEntity contributionEntity(FamilyContribution v) {
        ...
        e.setRegisteredBy(v.registeredBy());
        e.setNotes(v.notes());
        e.setCancelledAt(v.cancelledAt());
        e.setCancelledBy(v.cancelledBy());
        e.setCancellationReason(v.cancellationReason());
        e.setCreatedAt(v.createdAt());
        e.setUpdatedAt(v.updatedAt());
        return e;
    }
    ...
    private TreasuryExpenseEntity expenseEntity(TreasuryExpense v) {
        ...
        e.setAmount(v.amount());
        e.setExpenseDate(v.expenseDate());
        e.setCategory(v.category());
        e.setPaymentMethod(v.paymentMethod());
        e.setRecipient(v.recipient());
        e.setReceiptNumber(v.receiptNumber());
        e.setNotes(v.notes());
        e.setStatus(v.status());
        e.setRegisteredBy(v.registeredBy());
        e.setCancelledAt(v.cancelledAt());
    ...
    private TreasuryIncomeEntity incomeEntity(TreasuryIncome v) {
        ...
        e.setDescription(v.description());
        e.setAmount(v.amount());
        e.setIncomeDate(v.incomeDate());
        e.setCategory(v.category());
        e.setSource(v.source());
        e.setPaymentMethod(v.paymentMethod());
        e.setReceiptNumber(v.receiptNumber());
        e.setCourse(v.course());
        e.setFamilyId(v.familyId());
        e.setNotes(v.notes());
        e.setStatus(v.status());
        e.setRegisteredBy(v.registeredBy());
