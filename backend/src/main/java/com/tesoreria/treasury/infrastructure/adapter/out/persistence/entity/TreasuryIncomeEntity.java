...
public class TreasuryIncomeEntity {
  ...
  @Column(nullable = false, length = 250) private String description;
  @Column(nullable = false, precision = 14, scale = 0) private BigDecimal amount;
  @Column(name = "income_date", nullable = false) private LocalDate incomeDate;
  @Enumerated(EnumType.STRING) @Column(nullable = false, length = 35)
  private IncomeCategory category;
  @Column(length = 150) private String source;
  @Enumerated(EnumType.STRING) @Column(length = 20) private IncomePaymentMethod paymentMethod;
  @Column(length = 100) private String receiptNumber;
  @Column(length = 80) private String course;
  private Long familyId;
  @Column(length = 1000) private String notes;
  @Enumerated(EnumType.STRING) @Column(nullable = false, length = 20) private IncomeStatus status;
  @Column(nullable = false, length = 150) private String registeredBy;
