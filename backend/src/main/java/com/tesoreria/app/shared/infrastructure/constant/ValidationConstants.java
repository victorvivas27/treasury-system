package com.tesoreria.app.shared.infrastructure.constant;

public class ValidationConstants {
  private ValidationConstants() {
  }

  public static final int LONGITUD_MINIMA_NOMBRE = 3;
  public static final int LONGITUD_MAXIMA_NOMBRE = 50;
  public static final int LONGITUD_MAXIMA_EMAIL = 100;
